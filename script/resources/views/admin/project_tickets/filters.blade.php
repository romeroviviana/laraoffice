    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group filter-group">
                ...
                <?php
                $ticket_statuses = DB::table('ticketit_statuses')->get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
                ?>
                {!! Form::select('ticket_status', $ticket_statuses, old('ticket_status'), ['class' => 'form-control select2',  'data-live-search' => 'true', 'data-show-subtext' => 'true', 'id' => 'status_id_filter']) !!}
            </div>
        </div>
