						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									...
									<span class="add-new-menu-action">Menu for <b>{{$theme}}</b> theme</span>
								</form>
							</div>
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p id="menu-item-url-wrap">
																		<input id="custom-menu-item-url" name="url" type="text" class="code menu-item-textbox" placeholder="Path" value="">
																	</label>
																</p>
																...
																<p id="menu-item-name-wrap">
																	<label class="howto" for="custom-menu-item-icon_html"> <span>Icon HTML</span>&nbsp;
																		<input id="custom-menu-item-icon_html" name="icon_html" type="text" class="regular-text menu-item-textbox input-with-default-title" title="Label Icon."><br>
																		
																	</label>
																	Ex: &lt;i class="fa fa-life-saver"&gt;&lt;/i&gt;
																</p>

																<input id="permission" name="permission" type="hidden" class="regular-text menu-item-textbox input-with-default-title" title="Permission menu">
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														<ul class="menu ui-sortable" id="menu-to-edit">
															...
															<?php
															// dd( $m->theme );
															if ( ! empty($m->theme) && $theme != $m->theme ) {
																continue;
															}
															?>
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="description description-thin">
																		<label class="howto" for="edit-menu-item-icon_html-{{$m->id}}"> <span>Icon HTML</span>&nbsp;
																			<input id="idicon_htmlmenu_{{$m->id}}" name="icon_html" type="text" class="widefat edit-menu-item-icon_html" title="Label Icon" value="{{$m->icon_html}}">
																			Ex: &lt;i class="fa fa-life-saver"&gt;&lt;/i&gt;
																		</label>
																	</p>

																	<!--<p class="field-css-classes description description-thin">
																		<label for="edit-menu-item-classes-{{$m->id}}"> Permission
																			<br>
																			<input type="text" id="permission_menu_{{$m->id}}" class="widefat code edit-menu-item-permission" name="permission_menu_{{$m->id}}" value="{{$m->permission}}">
																		</label>
																	</p>-->
																	<input type="hidden" id="permission_menu_{{$m->id}}" class="widefat code edit-menu-item-permission" name="permission_menu_{{$m->id}}" value="{{$m->permission}}">
