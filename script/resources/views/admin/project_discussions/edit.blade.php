...
@section('content')
    ...
    {!! Form::model($topic, ['method' => 'PUT', 'route' => ['admin.project_discussions.update', $project->id, $topic->id]]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            @include('admin.project_discussions.form-fields', compact('topic', 'project'))            
        </div>
    </div>
