...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.internal_notifications.store'],'class'=>'formvalidation']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group">
                    {!! Form::label('text', trans('global.internal-notifications.fields.text').'*', ['class' => 'control-label form-label']) !!}
                    <div class="form-line">
                ...
                <div class="col-xs-{{COLUMNS}}">
                <div class="form-group">
                    {!! Form::label('link', trans('global.internal-notifications.fields.link').'', ['class' => 'control-label form-label']) !!}
                    <div class="form-line">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('users[]', $users, old('users'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-users' , 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('users'))
                        <p class="help-block">
                            {{ $errors->first('users') }}
