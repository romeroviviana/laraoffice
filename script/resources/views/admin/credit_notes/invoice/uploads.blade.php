...
@section('content')
    @include('admin.credit_notes.invoice.invoice-menu-uploads', compact('invoice'))
    <h3 class="page-title">@lang('custom.credit_notes.upload-documents')</h3>
    {!! Form::open(['method' => 'POST', 'route' => ['admin.credit_notes.process-upload', $invoice->slug], 'files' => true,]) !!}
      <div class="panel panel-default">
            <div class="panel-heading">
                @lang('custom.credit_notes.upload-documents')
            </div>
