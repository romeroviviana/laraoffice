...
<header>
			...
			<span style="margin-top: -20px; margin-right:0px;">
			<?php
            ...
            ?>
			<img alt="" src="{{asset( 'uploads/settings/' . $logo )}}" style="height: 40px; width:181px; color: #ff0000; float:right; margin-bottom: 180px; padding-right: 5px; margin-right: 50px;">
			...
			<table class="inventory" style="margin-right: 90px; margin-top: -20px;">
				<thead>
					<tr>
						...
						<th><span>@if( ! empty( $invoice->show_quantity_as ) )
                            {{$invoice->show_quantity_as}}
                        @else
                            {{ trans('custom.products.quantity') }}
                        @endif</span></th>
						<th><span>{{ trans('custom.products.rate') }}
...
<div class="column" style="float:right; margin-right: 90px;margin-top: -30px;">
    <header>
			<address>
...
@endif
		<!-- <aside style="margin-right: 90px; padding-top: -50px;">
