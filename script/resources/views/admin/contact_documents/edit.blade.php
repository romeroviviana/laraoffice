...
@section('content')
    ...
    {!! Form::model($contact_document, ['method' => 'PUT', 'route' => ['admin.contact_documents.update', $contact_document->id], 'files' => true,'class'=>'formvalidation']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($contact_document->getMedia('attachment') as $media)
                                <p class="form-group">
                                    ...
                                    <input type="hidden" name="attachment_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
