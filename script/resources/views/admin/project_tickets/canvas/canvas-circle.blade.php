 ...
 <div class="panel-default" aria-hidden="false">
   <div class="crm-invoice-summary">
           ...
           <div class="row">
               <div class="col-md-12">
                  <div class="col-md-4 crm-right-border-b5">
                   <div style="border-top-left-radius: 10px; width: 105%;" class="crm-invoice-summaries-b1 crm-invoice-summaries-b5">
                 ...
                 <div class="col-md-4 crm-right-border-b5">
                  <div style="width: 105%;" class="crm-invoice-summaries-b1 crm-invoice-summaries-b5" onclick="summarypriority('priority', 'high', 'circle')">
                           <div class="box-header text-uppercase text-bold" >
                           @lang('others.statistics.open-tickets')
                       </div>
                       <div class="box-content">
                           <?php
                  ...
                  <div class="col-md-4 crm-right-border-b5">
                    <div style="width: 105%;" class="crm-invoice-summaries-b1 crm-invoice-summaries-b5" onclick="summarypriority('priority', 'urgent', 'circle')">
                           <div class="box-header text-uppercase text-bold">
                           @lang('others.statistics.closed-tickets')
                       </div>
                       <div class="box-content">
                           <?php
