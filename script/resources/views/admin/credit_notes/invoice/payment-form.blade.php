...
<div class="modal-header">
  ...
  <h3>{{ trans('custom.credit_notes.credit_note_no') . $invoice->invoicenumberdisplay }} ({{digiCurrency( $amount_due, $invoice->currency_id )}}) </h3>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
       <?php
       $default_account = getSetting('default-account', 'credit-note-settings', 'offline');
       ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
      <textarea id="description" name="description" class="form-control">{{trans('custom.invoices.payment-for-creditnote') . ' ' . $invoice->invoice_no}}</textarea>
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
       <?php
       $default_category = getSetting('default_expense_caterory', 'credit-note-settings', '');
       ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" id="payer_name" name="payer_name" class="form-control" value="{{$customer->name ?? ''}}" disabled>
    </div>
  </div>
   <div class="form-group">
