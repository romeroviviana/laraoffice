...
<div class="panel panel-default filters">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
                <div class="col-md-2">
            <div class="form-group filter-group formsection">
            ...
            <div class="form-group filter-group">
              ...
              <div class="col-md-2">
            <div class="form-group filter-group formsection1" style="margin-left: -7px;">
                <label for="email">@lang('global.purchase-orders.fields.customer')</label>
                <?php
                $filtersuppliers = \App\Contact::whereHas("contact_type",
                   function ($query) {
                       $query->where('id', SUPPLIERS_TYPE);
                   })->get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
                ?>
                {!! Form::select('supplier', $filtersuppliers, old('supplier'), ['class' => 'form-control select2',  'data-live-search' => 'true', 'data-show-subtext' => 'true', 'id' => 'supplier']) !!}
            </div>
        </div>
