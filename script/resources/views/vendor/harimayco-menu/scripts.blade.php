<script>
	...
	var arraydata = [];     
	var addcustommenur= '{{ route("admin.navigation_menues.additem") }}';
	var updateitemr= '{{ route("admin.navigation_menues.updateitem")}}';
...
<script type="text/javascript" src="{{asset('js/navigation-menu.js')}}"></script>