...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.project_statuses.store'],'class'=>'formvalidation']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group">
                    {!! Form::label('name', trans('global.project-statuses.fields.name').'*', ['class' => 'control-label form-label']) !!}
                    <div class="form-line">
                ...
                <div class="col-xs-6">
                <div class="form-group">
                    {!! Form::label('description', trans('global.project-statuses.fields.description').'', ['class' => 'control-label']) !!}
