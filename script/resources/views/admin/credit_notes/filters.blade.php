    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group filter-group">
                ...
                <input type="text" class="form-control" name="date_filter"  id="date_filter" placeholder="@lang('others.statistics.select-date')" autocomplete="off">
            </div>
        </div>
                <div class="col-md-2">
            <div class="form-group filter-group">
                ...
                $date_types = array(
                    ...
                    'invoice_date' => trans('global.invoices.fields.credit-date'),
                );
                ?>
                ...
                <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="payment">@lang('global.credit_notes.fields.credit-status')</label>
                <?php
 
                   $enum_creditstatus = \App\CreditNote::$enum_credit_status;

                ?>
                {!! Form::select('credit_status', $enum_creditstatus, old('credit_status'), ['class' => 'form-control select2',  'data-live-search' => 'true', 'data-show-subtext' => 'true', 'placeholder' => 'Please Select','id' => 'status_id_filter']) !!}
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group filter-group">
                <label for="customer">@lang('others.statistics.customer')</label>
                 <?php   
