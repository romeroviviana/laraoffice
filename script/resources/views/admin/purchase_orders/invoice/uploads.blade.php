...
@section('content')
    @include('admin.purchase_orders.invoice.invoice-menu-uploads', compact('invoice'))
    <h3 class="page-title">@lang('custom.purchase_orders.upload-documents')</h3>
    {!! Form::open(['method' => 'POST', 'route' => ['admin.purchase_orders.process-upload', $invoice->slug], 'files' => true,]) !!}
      <div class="panel panel-default">
            <div class="panel-heading">
                @lang('custom.purchase_orders.upload-documents')
            </div>
