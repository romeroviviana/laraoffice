...
<div id="canvas" class="collapse canvas show">
    <div class="panel panel-default canvas">
        <div class="panel-heading">
        	@lang('others.statistics.client-projects-summary') 
        	<div class="col-sm-2 pull-right" style="margin-top:-7px;">
               ...
               ?>
                 ...
                 {!! Form::select('currency_id', $currencies, $default_currency, ['class' => 'form-control select2', 'required' => '', 'data-live-search' => 'true', 'data-show-subtext' => 'true', 'id' => 'currency_id', 'data-target' => route('admin.client_projects.refresh-stats')]) !!}
        ...
        <div class="panel-body table-responsive" id="canvas-panel-body">
			 @include('admin.client_projects.canvas.canvas-panel-body',['currency_id' => $default_currency])
		</div>
	</div>
</div>
@section('javascript') 
